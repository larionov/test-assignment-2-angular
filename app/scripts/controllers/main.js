...
angular.module('testAngular1App')
  .controller('MainCtrl', function ($scope) {
    ...
    $scope.exampleData = [
      ...
      {id: 22, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'None', kkal: 74, created: '2014-11-11'},
      {id: 23, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'Glazed', kkal: 11, created: '2014-12-06'},
      {id: 24, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'Sugar', kkal: 100, created: '2014-12-09'},
      {id: 25, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'Powdered Sugar', kkal: 79, created: '2014-12-16'},
      {id: 26, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'Chocolatewith Sprinkles', kkal: 64, created: '2014-02-09'},
      {id: 27, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'Chocolate', kkal: 88, created: '2014-02-10'},
      {id: 28, type: 'donut', name: 'Cake', batter: 'Devils Food', topping: 'Maple', kkal: 14, created: '2014-02-26'},
